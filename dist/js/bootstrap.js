...
(function (global, factory) {
  ...
  const DATA_KEY$7 = 'bs.password-input';
  const EVENT_KEY$7 = `.${DATA_KEY$7}`;
  const DATA_API_KEY$4 = '.data-api';
  const EVENT_CLICK_DATA_API$3 = `click${EVENT_KEY$7}${DATA_API_KEY$4}`;
  const SELECTOR_FORM_CONTROL = '.form-control';
  const SELECTOR_DATA_TOGGLE$5 = `${SELECTOR_FORM_CONTROL}:not([disabled]) ~ [data-bs-toggle="password"]`;
  ...
  const SELECTOR_DATA_TOGGLE$4 = '[data-bs-toggle="range-slider"]';
  ...
  const SELECTOR_DATA_TOGGLE$3 = '[data-bs-toggle="rating"]';
  ...
  const SELECTOR_DATA_TOGGLE$1 = '[data-bs-toggle="stepper"]';
